...
export function AlertDialogPage() {
  ...
  <AlertDialog.Trigger render={<Button color="destructive">Delete item</Button>} />
  <AlertDialog.Portal>
    ...
    <AlertDialog.Popup>
      ...
      <Preview
        ...
        code={`<AlertDialog.Root>
  <AlertDialog.Trigger render={<Button color="destructive">Leave page</Button>} />
  <AlertDialog.Portal>
    <AlertDialog.Backdrop />
    <AlertDialog.Popup>
  ...
  <AlertDialog.Portal>
    ...
    <AlertDialog.Popup>
      ...
      <AlertDialog.Description>By continuing, you agree to our terms.</AlertDialog.Description>
      <AlertDialog.Actions>
        <AlertDialog.Close render={<Button variant="ghost">Cancel</Button>} />
