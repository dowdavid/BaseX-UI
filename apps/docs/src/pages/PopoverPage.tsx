...
export function PopoverPage() {
  return (
    <>
      <Preview title="Basic" description="A simple popover with text content.">
        <Popover.Root>
      ...
      <Preview title="With close button" description="Popover that can be explicitly dismissed.">
        <Popover.Root>
          <Popover.Trigger render={<Button variant="outline" size="sm" />}>
            Dismissible
          </Popover.Trigger>
