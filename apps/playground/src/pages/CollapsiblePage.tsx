    ...
    <>
      ...
      >
        <Collapsible.Root>
          ...
          <Collapsible.Panel>
            ...
            Every component ships with an opinionated default style and is customizable via the sx
            prop.
          </Collapsible.Panel>
        </Collapsible.Root>
      </Preview>
      ...
      >
        <Collapsible.Root defaultOpen>
          ...
          <Collapsible.Panel>
            This panel starts open. Click the trigger to collapse it. The height transition
            animates smoothly in both directions using the keepMounted pattern.
          </Collapsible.Panel>
        </Collapsible.Root>
      </Preview>
